 ...
 */
final class Version20250226143919 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD seller_id INT NOT NULL, ADD buyer_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP seller_id, DROP buyer_id');
    }
}
