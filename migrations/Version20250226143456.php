 ...
 */
final class Version20250226143456 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, book_id INT NOT NULL, order_state_id INT NOT NULL, buyer_id INT NOT NULL, seller_id INT NOT NULL, purchase_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_F529939816A2B381 (book_id), UNIQUE INDEX UNIQ_F5299398E420DE70 (order_state_id), INDEX IDX_F52993986C755722 (buyer_id), INDEX IDX_F52993988DE820D9 (seller_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
